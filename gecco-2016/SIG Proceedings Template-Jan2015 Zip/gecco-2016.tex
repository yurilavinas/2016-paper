...
From~\cite{ogata2006space}, states alpha as the inverse of the magnitude of an event, or $magnitide^-1$. To obtain A, the following equation was used, from~\cite{yamanaka1990scaling}:
