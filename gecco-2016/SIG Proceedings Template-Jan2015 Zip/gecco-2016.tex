...
\begin{table}[!h]
  \begin{center}
  \caption{The default control parameter values and the best set of parameters found by tunning the algorithm with SMAC for the GAModel and the Emp-GAModel}
...
\multirow{4}{*}{Tohoku}
 & Parameter & Range & Default & Tuned \\
 \cline{2-5}
 & Crossover Chance & [0,1] & 0.9 & b 0.9\\
 & Mutation Chance & [0,1] & 0.1 & 0.1\\
  & Population Size & N/A & 500\\
 & Generation Number & [50,250] & 100 & 100 \\ \hline
